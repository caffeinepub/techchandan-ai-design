...
import type { ExternalBlob as _ExternalBlob, Order as _Order, ReferenceFile as _ReferenceFile, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async submitOrder(arg0: string, arg1: string, arg2: string, arg3: string, arg4: ReferenceFile | null): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitOrder(arg0, arg1, arg2, arg3, await to_candid_opt_n20(this._uploadFile, this._downloadFile, arg4));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_ReferenceFile_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ReferenceFile): Promise<ReferenceFile> {
...
async function from_candid_opt_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_ReferenceFile]): Promise<ReferenceFile | null> {
    return value.length === 0 ? null : await from_candid_ReferenceFile_n14(_uploadFile, _downloadFile, value[0]);
}
...
async function from_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        email: value.email,
        referenceFile: record_opt_to_undefined(await from_candid_opt_n13(_uploadFile, _downloadFile, value.referenceFile)),
...
async function to_candid_ReferenceFile_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: ReferenceFile): Promise<_ReferenceFile> {
...
async function to_candid_opt_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: ReferenceFile | null): Promise<[] | [_ReferenceFile]> {
    return value === null ? candid_none() : candid_some(await to_candid_ReferenceFile_n21(_uploadFile, _downloadFile, value));
}
